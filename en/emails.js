...
export default {
  'email.enrollAccount.subject':
    'Invitation to Socialize-starter for {username}',
  ...
  'email.enrollAccount.messageHtml':
    'We would like to invite you to Socialize-starter! We went ahead and prepared a personal account for you where you can access all features of Socialize-starter!',
  'email.enrollAccount.button': 'Access your account',
  'email.enrollAccount.signature':
    'We are looking forward to see you,<br />Socialize-starter team',
  // Reset password
