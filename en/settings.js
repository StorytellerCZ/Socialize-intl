export default {
  ...
  'settings.languages.join':
    'If you would like to help us, you can translate Socialize-starter as well.',
  ...
  'settings.gender.usage':
    'This information will remain private. We use this data for platform analytics and in anonymized analytics.',
  'settings.age.title': 'Your age',
  'settings.age.explicit': 'Show explicit content (rating age 21+)',
  'settings.age.usage':
    'This information will remain private. We are legally obliged to inquire about your age. We use this data for platform analytics, displaying content based on ratings and in anonymized analytics.',
  'settings.country.title': 'Your country',
  'settings.country.usage':
    'We are legally obliged to inquire about your country in order to respond to government inquiries. We use this data for platform analytics and in anonymized analytics. If you wish you can display this information on your profile.',
